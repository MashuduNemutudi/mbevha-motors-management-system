  ...
  return (
    <main>
          ...
          <div className="about-intro-grid">
            <div className="about-images">
              <img src="/images/gallery/img-exterior-wide.jpg" alt="Mbevha Motors Workshop"
                   className="about-images__main" loading="lazy" />
              <img src="/images/gallery/img-interior-bay.jpg" alt="Workshop interior"
                   className="about-images__secondary" loading="lazy" />
              ...
              {business.about ? (
                ...
                <>
                  <p className="about-text__lead">
                    {business.business_name || 'Mbevha Motors (Pty) Ltd'} is a professional automotive workshop based in Dzwerani, Limpopo,
                    founded on the belief that every vehicle deserves expert care and every customer deserves honest service.
                  </p>
                  <p>What started as a passion for mechanics has grown into a fully equipped workshop trusted by vehicle owners across the Vuwani area and beyond.</p>
                  <p>We are proud BMW mechanical specialists — one of the few workshops in the region with deep expertise in BMW diagnostics, repairs, and engine work across all generations.</p>
                  <p>Beyond BMWs, we service all makes and models — offering full mechanical repairs, vehicle servicing, brake and suspension work, engine swaps and conversions, and a constantly updated inventory of quality used parts.</p>
                </>
              )}
            </div>
          </div>
      ...
      <section className="section section--alt">
        <div className="container">
          <SectionTitle overline="Our Expertise" heading="What We Do"
            sub="A comprehensive range of automotive services under one roof." center />
          <div className="about-pillars">
            {[
              { icon: '🔧', title: 'General Workshop',    desc: 'Full mechanical repairs for all vehicle makes and models.' },
              { icon: '🏎️', title: 'BMW Experience',      desc: 'Specialised BMW diagnostic and repair capability across all generations.' },
              { icon: '⚙️', title: 'Engine Conversions',  desc: 'Complete engine conversion planning and installation.' },
              { icon: '🔄', title: 'Engine Swaps',        desc: 'Full engine swap services — planned, sourced, and completed in-house.' },
              { icon: '🛢️', title: 'Vehicle Servicing',   desc: 'Comprehensive service packages to keep your vehicle in peak condition.' },
              { icon: '🛞', title: 'Used Parts Sales',    desc: 'Tested, quality used parts sold directly from our workshop.' },
            ].map(p => (
      ...
      <section className="section">
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px', marginBottom: '64px' }}>
            <div style={{ background: 'var(--clr-darker)', borderRadius: '12px', padding: '40px' }}>
              ...
              <p style={{ color: '#aaa', lineHeight: '1.8', fontSize: '15px' }}>
                To deliver honest, expert automotive services that our customers in Limpopo can rely on — at fair prices, with quality workmanship, and without compromise.
              </p>
            </div>
            <div style={{ background: 'var(--clr-red)', borderRadius: '12px', padding: '40px' }}>
              <div style={{ fontSize: '40px', marginBottom: '16px' }}>🚀</div>
              ...
              <p style={{ color: 'rgba(255,255,255,0.85)', lineHeight: '1.8', fontSize: '15px' }}>
                To become the most trusted and respected automotive workshop in Limpopo — known for our BMW expertise, our quality used parts, and our commitment to every customer.
              </p>
            </div>
          </div>
      ...
      <section className="cta-banner">
        <div className="container cta-banner__content">
          ...
          <p className="cta-banner__sub">
            {business.address || 'Dzwerani, Mahematshena, Vuwani Road — Opposite Mavikos'}
          </p>
          <div className="cta-banner__actions">
            <a href={phoneHref} className="btn btn-outline-white btn-lg">
              📞 {business.phone || '071 306 5615'}
            </a>
